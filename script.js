...
const PHOTO_AMANDA = 'images/foto-amanda.jpeg';
const PHOTO_US = 'images/foto-nos.png';
...
function updatePlaceholderText(isUs) {
    ...
    if (code) {
        code.textContent = isUs
            ? 'images/foto-nos.png'
            : 'images/foto-amanda.jpeg';
    }
}
...
photoSwitch.addEventListener('change', () => {
    ...
    setTimeout(() => {
        ...
        if (isUs) {
            photo.classList.add('align-top');
        } else {
            photo.classList.remove('align-top');
        }
